...
<script type="text/javascript">
	function load() {
		if ("0" == '${sb1}') {
			...
			alert('${settleNo}'.replace("aaaaa", "结算单号为[").replace("bbbbbb","]的开票日期错误，请核对后再导入！"));
		}
...
<body onload="load()">
	<form id="file_upload_id" name="file_upload_name" action="resolveExcelForInvo" method="post" enctype="multipart/form-data">
		<div>
