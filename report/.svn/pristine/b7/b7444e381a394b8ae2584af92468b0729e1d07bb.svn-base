...
*
* @Title: DefaultSalesNoInDeliServiceImpl.java
* @Prject: report_center
* @Package: com.jshuabo.reportcenter.server.service.finance.impl
* @author: mingliang.zhuo
* @date: 2014年4月23日 上午10:42:42
* @version: 
* @Description: 
*/
package com.jshuabo.reportcenter.server.service.finance.impl;
...
/**
 * @ClassName: DefaultSalesNoInDeliServiceImpl
 * @Description: 
 * @author: mingliang.zhuo
 * @date: 2014年4月23日 上午10:42:42
 */
@Service("salesNoInDeliDataService")
public class DefaultSalesNoInDeliServiceImpl implements ISalesNoInDeliService{
    ...
    public String page(Map<String, Object> params) {
        ...
        List<SalesData> salesDateList = salesNoInDeliDataMapper.page(params);
        Long total = salesNoInDeliDataMapper.total(params);
    ...
    @Override
    public String salesNoInDeliDataDelete(String id) {
        try {
            salesNoInDeliDataMapper.salesNoInDeliDataDelete(id);
            return "1";
        } catch(Exception e) {
            e.printStackTrace();
            return "0";
    ...
    @Override
    public void salesNoInDeliMoreDele(HttpServletRequest request) {
        String suss = "0";
    ...
    public String deleteMoreSalesNoInDeli(HttpServletRequest request, @RequestParam("excelFile") MultipartFile multipartFile) {
        ...
        try {
            ...
            if (!fileName.endsWith(".xls") && !fileName.endsWith(".xlsx")) {
                return "redirect:/salesNoInDeliMoreDele?suss=3";
            }
            ...
            try {
                if (fileName.endsWith(".xls")) {
                    ...
                    if (!"序列号".equals(row.getCell(0).getStringCellValue())) {
                        return "redirect:/salesNoInDeliMoreDele?suss=2";
                    }
                    delResolve(sheet);
            ...
            e.printStackTrace();
            return "redirect:/salesNoInDeliMoreDele?suss=4";
        } finally {
        ...
        return "redirect:/salesNoInDeliMoreDele?suss=1";
    }
    ...
    private void delResolve(Sheet sheet) {
        ...
        salesNoInDeliDataMapper.deleteMore(list);
    }
}
