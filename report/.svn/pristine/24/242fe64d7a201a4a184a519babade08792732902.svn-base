...
<script type="text/javascript">
	function load() {
		if ("" != '${sb}') {
			...
			alert('${serialNo}'.replace("aaaaa", "序列号为[").replace("bbbbbb","]的销售日期错误，请核对后再导入！"));
		}
...
<body onload="load()">
	<form id="file_upload_id" name="file_upload_name" action="resolveExcelForSale" method="post" enctype="multipart/form-data">
		<div>
