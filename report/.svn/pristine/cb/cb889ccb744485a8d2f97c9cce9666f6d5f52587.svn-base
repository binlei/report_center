...
<body class="easyui-layout" style="width:100%;height:100%;" onkeydown="javascript:keyPressImpl(event);" onkeyup="javascript:keyReleaseImpl(event);">
			...
			<table id="dryLineTransferRecord" class="easy-table" style="width:100%;height:100%;">
				<thead>  
					<tr> 
						...
						<th data-options="field:'carcard',width:140,sortable : true, align:'center'">车号</th>
			           	<th data-options="field:'oilCardNo',width:160,sortable : true, align:'center'">油卡号</th>
						<th data-options="field:'transferDate',width:200,sortable : true, align:'center'">圈存时间</th>
						<th data-options="field:'transferMoney',width:120,sortable : true, align:'center'">圈存金额</th>
						<th data-options="field:'transferAddress',width:140,sortable : true, align:'center'">圈存地点</th>
		...
		<div id="menu" class="easyui-menu" style="width: 120px; display: none;">
			...
			<div id="dryLineTransferRecord_accumulate" onclick="importExcel('requestDepositPage','圈存记录导入');">导入圈存记录</div>
<!-- 			<div class="menu-sep"></div> -->
