...
<script type="text/javascript">
	function load() {
		if ("0" == '${l}') {
			...
			alert('${serialNo}'.replace("aaaaa", "序列号为[").replace("bbbbbb","]的报账日期错误，请核对后再导入！"));
		}
...
<body onload="load()">
	<form id="file_upload_id" name="file_upload_name" action="resolveExcelForReim" method="post" enctype="multipart/form-data">
		<div>
