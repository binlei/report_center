...
<script type="text/javascript">
	function load() {
		if ("" != '${sb}') {
			...
			alert('${settleNo}'.replace("aaaaa", "结算单号为[").replace("bbbbbb","]的U8预提月份或所属期间错误，请核对后再导入！"));
		}
...
<body onload="load()">
	<form id="file_upload_id" name="file_upload_name" action="resolveExcelForWithH" method="post" enctype="multipart/form-data">
		<div>
