				...
				<td align='center'>
					<div class="d_main">
						<table width="680px" height="390px" border="0px">
										...
										<form id="_formLogin">
											<table border="0" width="340px" height="110px">
												...
												<tr>
													...
													<td align="center">
														<input id="_login_img" type="image" src="images/btn_login.png" onclick="javascript:login()" />
													</td>
												</tr>
											</table>
										</form>
							...
							<tr>
								<td colspan="2">
									<div id="d_login_process_bar" class="bottom_1">
										<img src='images/login_processbar.gif' />
									</div>
								</td>
							</tr>
							<tr>
