	...
	function _255(_256) {
		...
		if (opts.buttons) {
			if ($.isArray(opts.buttons)) {
				...
				var _259 = $("<div class=\"dialog-button\"><div clss=\"dialog-message\" id=\"dialog_msg\" style=\"float: left; text-align: center;padding-top:5px;\"></div></div>").appendTo(
						_256);
	...
	var _688 = {
		...
		renderRow : function(_698, _699, _69a, _69b, _69c) {
			...
			if (_69a && opts.rownumbers) {
				...
				cc
						.push("<td style=\"border-style: ridge;border-top-style:none;\" class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">"
								+ _69d + "</div></td>");
			}
				...
				if (col) {
					...
					cc
							.push("<td field=\""
									...
									+ " "
									+ _6a2
									+ " style=\"border-style: ridge;border-top-style:none;\">");
					if (col.checkbox) {
						var _6a2 = "";
					} else {
						var _6a2 = _6a1;
