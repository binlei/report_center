...
<script type="text/javascript">
	function load() {
		if ("0" == '${l}') {
			...
			alert('${settleNo}'.replace("aaaaa", "结算单号为[").replace("bbbbbb","]的U8预提冲回月份错误，请核对后再导入！"));
		}
...
<body onload="load()">
	<form id="file_upload_id" name="file_upload_name" action="resolveExcelForWithR" method="post" enctype="multipart/form-data">
		<div>
