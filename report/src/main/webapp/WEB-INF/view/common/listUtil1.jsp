		...
		t
				.datagrid({
					...
					onRowContextMenu: function(e,index,row){
						if(row.extendProp1 != null) {
							e.preventDefault();
							$('#menu').menu('show', {
				                  left: e.pageX,
				                  top: e.pageY
				              });
							if(row.extendProp1 == '1') {
								$("#menu").menu('enableItem', $('#transportData_add1'));
								$("#menu").menu('disableItem', $('#transportData_add2'));
								$('#transportData_add1').attr("onclick","addInfoById()");
								$('#transportData_add2').attr("onclick","");
							} else if(row.extendProp1 == '2') {
								$("#menu").menu('enableItem', $('#transportData_add2'));
								$("#menu").menu('disableItem', $('#transportData_add1'));
								$('#transportData_add2').attr("onclick","updateInfoById()");
								$('#transportData_add1').attr("onclick","");
							}
