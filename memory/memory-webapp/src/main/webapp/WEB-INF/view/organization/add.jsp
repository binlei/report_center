...
<form class="cmxform" id="commentForm" method="post" >
		<table class="table_border" border="1" width="400px" height="350px">
					...
					<tr>
						...
						<td>
							<input name="managerContact.tel" id="managerContact.tel"   class="easyui-validatebox" data-options="validType:'mobile'"/>
						</td>
					</tr>
					<tr>
						<td class="title" >
						...
						<td>
							<select id="getChannelType" name="type.id" class="easyui-validatebox" data-options="required:true" ></select>
						</td>
						</tr>
					<tr>
						<td class="title" ><font color="red">*&nbsp;</font>状态
						</td>
						<td><div class="radioDiv">
					...
					<tr>
						...
						<td>
							<textarea  name="description" id="description"  class="easyui-validatebox" validType="length[0,200]" invalidMessage="不能超过200个字符"></textarea>
						</td>
					</tr>
					<tr>
